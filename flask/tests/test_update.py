...
class TestUpdateObjects(BaseTestCase):
    ...
    def test_update_desktop(self):
        with self.client:
            ...
            DesktopController.create_desktop('LG', 500, 100, 'intel', 32, 4, 20, '20x20')
    ...
    def test_update_laptop(self):
        with self.client:
            ...
            LaptopController.create_laptop('Asus', 600, 200, '32x32', 'intel', 64, 2, 40, 'Long lasting battery', 'Windows 10', False, True)
    ...
    def test_update_monitor(self):
        with self.client:
            ...
            MonitorController.create_monitor('Apple', 300, 5, '25x30')
    ...
    def test_update_tablet(self):
        with self.client:
            ...
            TabletController.create_tablet('Samsung', 1200, 1.2, '10x12', '10x12', 'intel', 8, 2, 250, 'Long lasting battery', 'Windows 10', 'Good camera')
